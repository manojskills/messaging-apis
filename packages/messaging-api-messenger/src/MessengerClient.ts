...
export default class MessengerClient {
  ...
  getMessagingFeatureReview(): Promise<Types.MessagingFeatureReview[]> {
    return this.axios
      .get<{ data: Types.MessagingFeatureReview[] }>(`/me/messaging_feature_review?access_token=${this.accessToken}`)
      .then((res) => res.data.data, handleError);
  }
  ...
  uploadAttachment(
    ...
    return this.axios
      .post<{ attachmentId: string }>(`/me/message_attachments?access_token=${this.accessToken}`, ...args)
      .then((res) => res.data, handleError);
  }
